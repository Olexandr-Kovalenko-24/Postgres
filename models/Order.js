...
class Order {
    ...
    // const {rows: orders} = await this._client.query(`INSERT INTO orders (customer_id) VALUES 
    //     ${ordersValuesString} RETURNING id;`);
    ...
    return await this._client.query(`INSERT INTO orders_to_products (order_id, product_id, quantity) VALUES
    ${phonesToOrdersValueString};`);
    }
}
